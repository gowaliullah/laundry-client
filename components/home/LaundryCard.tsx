...
const LaundryCard: FC<LaundryCardProps> = ({ name, imageSrc, rating }) => {
  ...
  return (
    <div className="bg-white p-4 rounded-xl shadow-md text-center flex flex-col items-center space-y-4">
      {/* Circle Image */}
      ...
      {/* Button (you can replace this with ShadCN Button if using) */}
